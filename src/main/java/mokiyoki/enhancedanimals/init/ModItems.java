...
public class ModItems {
    ...
    public static final Item RawChicken_Pale = new RawChicken(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(2).saturation(2.2F).effect(new EffectInstance(Effects.HUNGER, 600, 0), 0.3F).meat().build())).setRegistryName(Reference.MODID, "rawchicken_pale");
    public static final Item CookedChicken_DarkSmall = new CookedChicken(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(3).saturation(3.6F).meat().build())).setRegistryName(Reference.MODID, "cookedchicken_darksmall");
    public static final Item CookedChicken_Dark = new CookedChicken(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(6).saturation(7.2F).meat().build())).setRegistryName(Reference.MODID, "cookedchicken_dark");
    public static final Item CookedChicken_DarkBig = new CookedChicken(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(6).saturation(10.2F).meat().build())).setRegistryName(Reference.MODID, "cookedchicken_darkbig");
    public static final Item CookedChicken_PaleSmall = new CookedChicken(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(3).saturation(3.6F).meat().build())).setRegistryName(Reference.MODID, "cookedchicken_palesmall");
    public static final Item CookedChicken_Pale = new CookedChicken(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(6).saturation(10.2F).meat().build())).setRegistryName(Reference.MODID, "cookedchicken_pale");
    public static final Item RawRabbit_Small = new RawRabbit(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(1).saturation(1.1F).meat().build())).setRegistryName(Reference.MODID, "rawrabbit_small");
    public static final Item CookedRabbit_Small = new CookedRabbit(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(4).saturation(5F).meat().build())).setRegistryName(Reference.MODID, "cookedrabbit_small");
    public static final Item RabbitStew_Weak = new RabbitStew(new Item.Properties().group(EnhancedAnimals.GENETICS_ANIMALS_GROUP).maxStackSize(64).food((new Food.Builder()).hunger(8).saturation(10F).meat().build())).setRegistryName(Reference.MODID, "rabbitstew_weak");
