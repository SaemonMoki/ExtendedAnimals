...
public class ModItems {
    ...
    public static final Item Half_Milk_Bottle = new MilkBottleHalf(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.GLASS_BOTTLE).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "half_milk_bottle");
    public static final Item Milk_Bottle = new MilkBottle(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.GLASS_BOTTLE).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "milk_bottle");
    public static final Item OneSixth_Milk_Bucket = new MilkBucketOneSixth(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.BUCKET).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "onesixth_milk_bucket");
    public static final Item OneThird_Milk_Bucket = new MilkBucketOneThird(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.BUCKET).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "onethird_milk_bucket");
    public static final Item Half_Milk_Bucket = new MilkBucketHalf(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.BUCKET).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "half_milk_bucket");
    public static final Item TwoThirds_Milk_Bucket = new MilkBucketTwoThirds(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.BUCKET).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "twothirds_milk_bucket");
    public static final Item FiveSixths_Milk_Bucket = new MilkBucketFiveSixths(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).containerItem(Items.BUCKET).food((new Food.Builder()).setAlwaysEdible().hunger(0).saturation(0F).build())).setRegistryName(Reference.MODID, "fivesixths_milk_bucket");
