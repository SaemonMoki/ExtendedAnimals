...
public class EnhancedLayeredTexturer extends AbstractTexture {
    ...
    public EnhancedLayeredTexturer(String modLocation, String[] textureNames, String[] maskingTextureNames, Colouration colouration) {
        this.animalTextureGrouping = null;
    ...
    private void loadNewWay(ResourceManager manager) {
