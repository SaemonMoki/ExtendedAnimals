...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<EnhancedCat>> ENHANCED_CAT = ENTITIES_DEFERRED_REGISTRY.register("enhanced_cat", () -> EntityType.Builder.of(EnhancedCat::new, MobCategory.CREATURE).sized(1.0F, 1.0F).build(Reference.MODID + ":enhanced_cat"));
