...
public class LlamaBreeds {
    ...
    public static final Breed BLUEEYEWHITE = new Breed(new Breed.Properties().setData("BlueEyesWhite", Biomes.WINDSWEPT_FOREST, Breed.Rarity.EXOTIC).setGeneSketch(new GeneSketch(), new GeneSketch().add(6, "1").add(10, "2")));
