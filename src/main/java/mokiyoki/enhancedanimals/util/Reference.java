...
public class Reference {
    ...
    public static final String VERSION = "0.8.70";
    ...
    public static final int CHICKEN_AUTOSOMAL_GENES_LENGTH = 308;
    ...
    public static final int TURTLE_AUTOSOMAL_GENES_LENGTH = 78;
