...
public class PigBreeds {
    ...
    public static final Breed MULEFOOT = new Breed(new Breed.Properties().setData("Mulefoot", 0.7F, 0.8F, Breed.Rarity.RARE)
    ...
    public static final Breed KUNEKUNE = new Breed(new Breed.Properties().setData("KuneKune", 0.7F, 0.8F, Breed.Rarity.RARE)
            .setGeneSketch(new GeneSketch(), new GeneSketch().add(0, "3","1").add(4,"40%1","2").add(6,"25%2","1").add(10, "1","3","1").add(18, "5").add(32, "1","1","2","1|2","1","4","3","2").add(50, "1","3").add(58, "2").add(66, "5").add(68, "2","1|2","1","1","1").add(174, "5-8","5-8","4|5","4|5").add(182, "3|4","3|4","3|4","3|4").add(202, "3", "2|3")));
    public static final Breed PIETRAIN = new Breed(new Breed.Properties().setData("Pietrain", 0.7F, 0.8F, Breed.Rarity.RARE)
    ...
    public static final Breed PROTESTPIG = new Breed(new Breed.Properties().setData("DanishProtestPigHusumRedPied", 0.7F, 0.8F, Breed.Rarity.RARE)
    ...
    public static final Breed MANGALITSA = new Breed(new Breed.Properties().setData("Mangalitsa", 0.7F, 0.8F, Breed.Rarity.RARE)
    ...
    public static final Breed HEREFORDHOG = new Breed(new Breed.Properties().setData("HerefordHog", 0.7F, 0.8F, Breed.Rarity.RARE)
