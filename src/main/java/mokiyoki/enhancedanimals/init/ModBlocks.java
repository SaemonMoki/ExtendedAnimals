...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> AXOLOTL_BUCKET_BLOCK = BLOCKS_DEFERRED_REGISTRY.register("enhanced_axolotl_bucket", () -> new EggCartonBlock(Block.Properties.of(Material.WOOL, MaterialColor.COLOR_LIGHT_GRAY).strength(0.0F).sound(SoundType.WOOL).noOcclusion()));
