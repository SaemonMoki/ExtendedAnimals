...
public class LlamaBreeds {
    ...
    public static final Breed WOOLY = new Breed(new Breed.Properties().setData("WoolyWoolie", Biomes.WINDSWEPT_HILLS, Breed.Rarity.UNCOMMON).setGeneSketch(new GeneSketch(), new GeneSketch().add(20,"1","3","1","2")));
}
