...
public class Reference {
    ...
    public static final String VERSION = "0.8.24";
    ...
    public static final int FOX_AUTOSOMAL_GENES_LENGTH = 120; //number of genes and alleles - size of int array that holds genes
}
