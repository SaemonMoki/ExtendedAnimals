...
//    protected static final Predicate<BlockState> IS_SPARSE_GRASS_BLOCK = BlockStatePredicate.forBlock(ModBlocks.SPARSEGRASS_BLOCK);
...
//            Vec3 vec3d = RandomPos.getLandPos(this.creature, 15, 7);
//            return vec3d == null ? super.getPosition() : vec3d;
//        } else {
//            return this.creature.getRandom().nextFloat() >= this.probability ? RandomPos.getLandPos(this.creature, 5, 5) : super.getPosition();
//        }
//    }
//
