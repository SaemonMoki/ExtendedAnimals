...
public class EnhancedCow extends EntityAnimal {
    ...
    //TODO put new cow behaviour here 
...
//    }
    ...
    public String getCowTexture() {
        ...
        return this.cowTextures.stream().collect(Collectors.joining(", ","[","]"));
...
//                if (false) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof EnhancedCow.GroupData) {
            spawnGenes = ((EnhancedCow.GroupData) livingdata).groupGenes;
        } else {
            spawnGenes = createInitialGenes();
            livingdata = new EnhancedCow.GroupData(spawnGenes);
        }
