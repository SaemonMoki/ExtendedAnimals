...
public class ClientEventRegistry {
    ...
    @SubscribeEvent
    public static void onBlockColouredEvent(RegisterColorHandlersEvent.Block event) {
...
//                ModBlocks.AXOLOTL_EGG.get());
    ...
    @SubscribeEvent
    public static void onItemColouredEvent(RegisterColorHandlersEvent.Item event) {
        ...
        event.register((itemStack, tintIndex) -> tintIndex > 0 ? -1 : ((DyeableLeatherItem)itemStack.getItem()).getColor(itemStack),
