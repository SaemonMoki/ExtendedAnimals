...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BEE_NEST = BLOCKS_DEFERRED_REGISTRY.register("bee_nest", () -> new EnhancedBeeNestBlock(1, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_YELLOW).strength(0.3F).sound(SoundType.WOOD).noOcclusion().noCollission()));
    public static final RegistryObject<Block> BEEHIVE = BLOCKS_DEFERRED_REGISTRY.register("beehive", () -> new EnhancedBeeNestBlock(-1, BlockBehaviour.Properties.of(Material.WOOD).strength(0.6F).sound(SoundType.WOOD)));
