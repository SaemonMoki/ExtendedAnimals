...
public class RenderEnhancedFox extends MobRenderer<EnhancedFox, ModelEnhancedFox<EnhancedFox>> {
    ...
    private static final ResourceLocation ERROR_TEXTURE_LOCATION = new ResourceLocation("eanimod:textures/entities/fox/foxbase.png");
    ...
    public ResourceLocation getTextureLocation(EnhancedFox entity) {
        ...
        if (resourcelocation == null) {
            ...
            try {
                ...
                Minecraft.getInstance().getTextureManager().register(resourcelocation, new EnhancedLayeredTexture(ENHANCED_FOX_TEXTURE_LOCATION, textures, entity.getVariantAlphaTexturePaths(), colourRGB));
