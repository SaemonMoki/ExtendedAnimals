...
import mokiyoki.enhancedanimals.renderer.RenderEnhancedFox;
...
//        event.registerEntityRenderer(ENHANCED_HORSE.get(), RenderEnhancedHorse::new);
        ...
        event.registerEntityRenderer(ENHANCED_FOX.get(), RenderEnhancedFox::new);
    ...
    public static void registerLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(RenderEnhancedFox.FOX_LAYER, ModelEnhancedFox::createBodyLayer);
