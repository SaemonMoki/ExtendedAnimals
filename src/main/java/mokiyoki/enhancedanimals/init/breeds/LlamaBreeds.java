...
public class LlamaBreeds {
    ...
    public static final Breed WOOLLY = new Breed(new Breed.Properties().setData("WoolyWoolie", 0.2F, 0.3F, Breed.Rarity.UNCOMMON).setGeneSketch(new GeneSketch(), new GeneSketch().add(20,"1","3","1","2")));
}
