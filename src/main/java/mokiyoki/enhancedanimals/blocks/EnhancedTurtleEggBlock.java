...
public class EnhancedTurtleEggBlock extends Block {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        boolean autoHatch = worldIn.getBlockState(pos.east()).getBlock()==Blocks.TORCH;
        if ((this.canGrow(worldIn) || autoHatch) && hasProperHabitat(worldIn, pos)) {
            ...
            if (i < 2 && !autoHatch) {
                ...
                for(EggHolder egg : eggList) {
                    ...
                    turtle.setBirthTime(String.valueOf(worldIn.getGameTime()));
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        EggHolder eggHolder = context.getItem().getCapability(EggCapabilityProvider.EGG_CAP, null).orElse(null).getEggHolder();
        context.getWorld().getCapability(NestCapabilityProvider.NEST_CAP, null).orElse(new NestCapabilityProvider()).addNestEggPos(context.getPos(), eggHolder.getSire(), eggHolder.getDam(), eggHolder.getGenes());
