...
//            Float ageFloat = ageInt >= 20 ? (float)(ageInt/10) : (float)ageInt/10.0F;
            ...
            if (s > 8) {
                ...
                this.font.drawString(s > 12 ? sireName.substring(0, 12) : sireName, i + 99, j + 40, 4210752);
                if (d > 8) {
                    this.font.drawString("Dam:", i + 99, j + 51, 4210752);
                    this.font.drawString(d > 12 ? damName.substring(0, 12) : damName, i + 99, j + 60, 4210752);
                } else {
                ...
                if (d > 8) {
                    ...
                    this.font.drawString( d > 12 ? damName.substring(0, 12) : damName, i + 99, j + 50, 4210752);
                } else {
